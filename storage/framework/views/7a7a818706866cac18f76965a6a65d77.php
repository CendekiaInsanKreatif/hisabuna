...
<body>
    <header class="header">
        ...
        <br>
        <br>
        <h2><u><?php echo e($jurnal['jenis'] == 'RV' ? 'JURNAL KAS MASUK' : ($jurnal['jenis'] == 'PV' ? 'JURNAL KAS KELUAR' : ($jurnal['jenis'] == 'JV' ? 'JURNAL UMUM' : ''))); ?></u></h2>
        <h4><?php echo e($jurnal['jenis'] == 'RV' ? 'RECEIVE VOUCHER' : ($jurnal['jenis'] == 'PV' ? 'PAYMENT VOUCHER' : ($jurnal['jenis'] == 'JV' ? 'JOURNAL VOUCHER' : ''))); ?></h4>
    </header>
    <br>
    <table>
        <tbody>
...
<?php /**PATH /var/www/hisabuna/resources/views/report/transaksi.blade.php ENDPATH**/ ?>