...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => ''.e($item['name']).'','name' => ''.e($item['name']).'','type' => ''.e($item['type']).'','class' => 'mt-1 block w-full','xBind:readonly' => 'name.includes(\'show\')','xBind:disabled' => 'name.includes(\'show\')','placeholder' => $item['name'] === 'no_transaksi' ? 'Generate By System' : __($item['label']),'xModel' => 'name.includes(\'create\') ? \'\' : data.'.e($item['name']).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => ''.e($item['name']).'','name' => ''.e($item['name']).'','type' => ''.e($item['type']).'','class' => 'mt-1 block w-full','x-bind:readonly' => 'name.includes(\'show\')','x-bind:disabled' => 'name.includes(\'show\')','placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($item['name'] === 'no_transaksi' ? 'Generate By System' : __($item['label'])),'x-model' => 'name.includes(\'create\') ? \'\' : data.'.e($item['name']).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                            ...
                            <?php $__currentLoopData = $field; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($index % 2 != 0): ?>
                                    <div class="mt-4">
                                        ...
                                        <?php if (isset($component)) { $__componentOriginal18c21970322f9e5c938bc954620c12bb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal18c21970322f9e5c938bc954620c12bb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => ''.e($item['name']).'','name' => ''.e($item['name']).'','type' => ''.e($item['type']).'','class' => 'mt-1 block w-full','xBind:readonly' => 'name.includes(\'show\')','xBind:disabled' => 'name.includes(\'show\')','placeholder' => ''.e(__($item['label'])).'','xModel' => 'name.includes(\'create\') ? \'\' : data.'.e($item['name']).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => ''.e($item['name']).'','name' => ''.e($item['name']).'','type' => ''.e($item['type']).'','class' => 'mt-1 block w-full','x-bind:readonly' => 'name.includes(\'show\')','x-bind:disabled' => 'name.includes(\'show\')','placeholder' => ''.e(__($item['label'])).'','x-model' => 'name.includes(\'create\') ? \'\' : data.'.e($item['name']).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal18c21970322f9e5c938bc954620c12bb)): ?>
<?php $attributes = $__attributesOriginal18c21970322f9e5c938bc954620c12bb; ?>
...
<?php /**PATH C:\dedeProject\Development\hisabuna\resources\views/components/modal.blade.php ENDPATH**/ ?>