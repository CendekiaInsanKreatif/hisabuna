...
<div x-data="{
    ...
    <div x-show="show"
        class="mb-6 bg-white rounded-2xl overflow-hidden shadow-xl transform transition-all sm:w-full <?php echo e($maxWidth); ?> sm:mx-auto border border-secondary-200/50"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6" x-data="data">
                                <div class="space-y-4">
                                    <?php $__currentLoopData = $field; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($index % 2 == 0): ?>
                                            <div>
                                                <label for="<?php echo e($item['name']); ?>" class="form-label"><?php echo e(__($item['label'])); ?></label>
                                                ...
                                                <?php else: ?>
                                                    <input id="<?php echo e($item['name']); ?>" name="<?php echo e($item['name']); ?>"
                                                        type="<?php echo e($item['type']); ?>" class="form-input"
                                                        x-bind:readonly="name.includes('show')"
                                                        x-on:input="name.includes('saldo-awal') ? formatCurrency($event) : formatInputAkun($event)"
                                                        maxlength="10"
                                                        x-bind:disabled="name.includes('show') ? true : (name.includes('saldo-awal') ? data.saldo_normal == 'credit' : false)"
                                                        :placeholder="name === 'no_transaksi' ? 'Generate By System' : '<?php echo e(__($item['label'])); ?>'"
                                                        x-bind:value="name.includes('create') ? '' : (name.includes('saldo-awal') ? formatCurrencyValue(data.<?php echo e($item['name']); ?>) : data.<?php echo e($item['name']); ?>)" />
                                                <?php endif; ?>
                                            </div>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div>
                                                ...
                                                <?php else: ?>
                                                    <input id="<?php echo e($item['name']); ?>" name="<?php echo e($item['name']); ?>"
                                                        ...
                                                        placeholder="<?php echo e(__($item['label'])); ?>"
                                                        x-bind:value="name.includes('create') ? '' : (name.includes('saldo-awal') ? formatCurrencyValue(data.<?php echo e($item['name']); ?>) : data.<?php echo e($item['name']); ?>)" />
                                                <?php endif; ?>
                                            </div>
                                        <?php endif; ?>
                                    ...
                                    <thead class="sticky top-0">
                                        ...
                                        <tr>
                                            <?php $__currentLoopData = $header; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <th class="t-head text-center"><?php echo e($item); ?></th>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </tr>
                                    </thead>
                                    <tbody class="bg-white divide-y divide-secondary-100">
...
<?php /**PATH /var/www/hisabuna/backend/resources/views/components/modal.blade.php ENDPATH**/ ?>