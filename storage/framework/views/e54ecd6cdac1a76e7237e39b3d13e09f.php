                ...
                <div class="flex flex-wrap md:flex-nowrap">
                    ...
                    <div class="md:w-1/2 p-6 space-y-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <input type="text" name="company_name" id="company_name" value="<?php echo e(auth()->user()->company->name); ?>" required class="mt-1 block w-full px-4 py-3 border border-gray-400 rounded-lg shadow focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm" <?php if(!auth()->user()['roles'] == (['superadmin', 'admin'])): ?> disabled <?php endif; ?>>
                        </div>
                        <div class="space-y-4">
                            <label for="company_desc" class="block text-sm font-medium text-gray-800">Deskripsi Perusahaan</label>
                            <textarea name="company_desc" id="company_desc" rows="4" class="mt-1 block w-full px-4 py-3 border border-gray-400 rounded-lg shadow focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm" <?php if(!auth()->user()['roles'] == (['superadmin', 'admin'])): ?> disabled <?php endif; ?>><?php echo e(auth()->user()->company->desc); ?></textarea>
                        </div>
                    </div>
                </div>
