            ...
            <div class="flex flex-wrap items-center justify-between">
                <div id="filterAkun" class="flex-grow rounded p-3 flex flex-wrap gap-2 w-full md:w-auto justify-between">
                    <div class="flex flex-wrap gap-2 h-fit">
                        ...
                        <a href="{{ route('report.daftarjurnal') }}" class="btn bg-gray-200 rounded px-3 py-2 hover:bg-emerald-500 transition duration-300 text-sm"><p style="line-height: 1.5;">Daftar Jurnal</p></a>
                    </div>
                    <a role="button" class="text-base py-2 px-4 inline-flex items-center justify-center bg-emerald-500 border border-transparent rounded-md text-white hover:bg-emerald-700 focus:bg-emerald-700 active:bg-emerald-900 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 transition ease-in-out duration-150" href="{{ route('jurnal.create') }}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 28 28" class="mr-2">
                                ...
                                <tr @mouseover="hover = true" @mouseout="hover = false" class="hover:bg-gray-100">
                                    ...
                                    <td class="text-left  px-3 py-2">
                                        <div class="flex items-center flex-col md:flex-row gap-2">
                                            <a class="px-2 py-1 text-emerald-600 border border-emerald-600 rounded text-sm hover:bg-emerald-100 focus:bg-emerald-500 active:bg-emerald-900 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 transition ease-in-out duration-150" :href="`{{ url('jurnal') }}/${jurnal.id}/edit`">
                                                Edit
                                            </a>
                                        ...
                                        >{{ __('View') }}</a>
                                        <a :href="`{{ route('report.transaksi', '') }}/${jurnal.id}`" target="_blank" class="btn border border-zinc-300 rounded items-center justify-center hover:bg-emerald-500 transition duration-300 h-fit text-sm px-2 py-1">Print</a>
