        ...
        <div class="flex justify-between w-full">
            <div class="flex items-center space-x-4 sm:space-x-6">
                <div class="flex-shrink-0">
                    <img src="<?php echo e(asset('images/brand/logo-hisabuna-color.svg')); ?>" alt="Logo Hisabuna" class="h-9 w-auto">
                </div>
            ...
            <div id="btnProfile" class="flex items-center space-x-2 md:space-x-4">
                ...
                <a href="<?php echo e(route('profile.edit')); ?>" class="w-12 h-12 md:w-14 md:h-14 rounded-full overflow-hidden hover:scale-110 transition-transform duration-300">
                    <img src="<?php echo e(asset('images/dummy-company.png')); ?>" alt="User" class="w-full h-full object-cover">
                </a>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\dedeProject\Development\hisabuna\resources\views\layouts\app.blade.php ENDPATH**/ ?>