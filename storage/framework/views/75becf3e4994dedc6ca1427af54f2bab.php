...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('storage/' . auth()->user()->company_logo)); ?>">
...
<body>
    ...
    <header class="new-header">
        ...
        <div class="header" style="text-align: center;">
            ...
            <h2>Daftar Jurnal</h2>
            <h3>Jurnal ke <?php echo e($tgl_awal); ?> s/d <?php echo e($tgl_akhir); ?></h3>
        </div>
    </header>
        <!-- <div class="header-content" style="text-align: center; width: 100%;">
            <div id="titleHeader" class="header-text" style="display: flex; align-items: center; justify-content: center; flex-direction: row;">
                <img src="<?php echo e(asset('storage/' . auth()->user()->company_logo)); ?>" alt="Logo" class="company-logo" style="width: 6rem; margin-right: 15px;">
                <div style="display: flex; align-items: center;">
                    <h2 style="padding: 0; margin: 0;"><?php echo e(auth()->user()->company_name); ?></h2>
                </div>
            </div>
            <br>
            <div class="title">
                <h2>DAFTAR JURNAL</h2>
                <p class="period">Periode <?php echo e($tgl_awal); ?> s/d <?php echo e($tgl_akhir); ?></p>
            </div>
        </div> -->
        ...
        <table>
            ...
            <tbody>
                <?php $__currentLoopData = $jurnal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr style="<?php echo e($item->jenis == 'RV' ? 'background-color: #fee2e2;' : ($item->jenis == 'PV' ? 'background-color: #f4f4f5;' : ($item->jenis == 'JV' ? 'background-color: #fef9c3;' : ''))); ?> border-bottom: 1px solid #333;">
                        <td style="text-align: center;"><?php echo e($item->no_urut_transaksi); ?></td>
                        <td style="text-align: center;"><?php echo e($item->jenis); ?></td>
                        <td style="word-wrap: break-word; max-width: 60%;"><?php echo e($item->keterangan); ?></td>
...
<?php /**PATH /var/www/hisabuna/backend/resources/views/report/daftarjurnal.blade.php ENDPATH**/ ?>