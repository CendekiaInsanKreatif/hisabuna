            ...
            <table>
                ...
                <tbody>
                    @foreach ($data as $golongan => $golonganData)
                        <tr>
                            <td colspan="8">
                                <h2 style="text-align: left;">{{ $golongan }}</h2>
                            </td>
                        </tr>
                        @php
                        ...
                        @foreach ($golonganData as $nomor_akun => $detail)
                            <tr>
                                ...
                                <td class="text-right">{{ number_format($detail['saldo_awal']['debit'], 0, ',', '.') }}
                                </td>
                                <td class="text-right">{{ number_format($detail['saldo_awal']['credit'], 0, ',', '.') }}
                                </td>
                                <td class="text-right">{{ number_format($detail['mutasi']['debit'], 0, ',', '.') }}</td>
                                <td class="text-right">{{ number_format($detail['mutasi']['credit'], 0, ',', '.') }}
                                </td>
                                <td class="text-right">{{ number_format($detail['saldo_akhir']['debit'], 0, ',', '.') }}
                                </td>
                                <td class="text-right">
                                    {{ number_format($detail['saldo_akhir']['credit'], 0, ',', '.') }}</td>
                            </tr>
                            @php
            ...
            @foreach ($subTotal as $subIndex => $subTotalValue)
                <tr>
                    <td colspan="2" style="width: 100%;">
                        <h2 style="text-align: left;">{{ $subTotal['Jumlah']['nama_akun'] }}</h2>
                    </td>
                    <td class="jumlah" style="width: 0%; text-align: right;">
                        {{ number_format($subTotal['Jumlah']['saldo_awal']['debit'], 0, ',', '.') }}</td>
                    <td class="jumlah" style="width: 0%; text-align: right;">
                        {{ number_format($subTotal['Jumlah']['saldo_awal']['kredit'], 0, ',', '.') }}</td>
                    <td class="jumlah" style="width: 0%; text-align: right;">
                        {{ number_format($subTotal['Jumlah']['mutasi']['debit'], 0, ',', '.') }}</td>
                    <td class="jumlah" style="width: 0%; text-align: right;">
                        {{ number_format($subTotal['Jumlah']['mutasi']['kredit'], 0, ',', '.') }}</td>
                    <td class="jumlah" style="width: 0%; text-align: right;">
                        {{ number_format($subTotal['Jumlah']['saldo_akhir']['debit'], 0, ',', '.') }}</td>
                    <td class="jumlah" style="width: 0%; text-align: right;">
                        {{ number_format($subTotal['Jumlah']['saldo_akhir']['kredit'], 0, ',', '.') }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
