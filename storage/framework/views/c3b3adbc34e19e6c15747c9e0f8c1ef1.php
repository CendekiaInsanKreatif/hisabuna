...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td>Modal Disetor</td>
                <td style="text-align: right;"><?php echo e(number_format($modal2024, 0, ',', '.')); ?></td>
                <td style="text-align: right;"><?php echo e(number_format($modalDiff, 0, ',', '.')); ?></td>
                <td style="text-align: right;"><?php echo e(number_format($modal2023, 0, ',', '.')); ?></td>
            </tr>
            <tr>
                <td>Saldo Tahun Berjalan</td>
                <td style="text-align: right;"><?php echo e(number_format($saldo2024, 0, ',', '.')); ?></td>
                <td style="text-align: right;"><?php echo e(number_format($saldoDiff, 0, ',', '.')); ?></td>
                <td style="text-align: right;"><?php echo e(number_format($saldo2023, 0, ',', '.')); ?></td>
            </tr>
            <tr class="total">
                <td>Jumlah Ekuitas</td>
                <td style="text-align: right;"><?php echo e(number_format($modal2024 + $saldo2024, 0, ',', '.')); ?></td>
                <td style="text-align: right;"><?php echo e(number_format($modalDiff + $saldoDiff, 0, ',', '.')); ?></td>
                <td style="text-align: right;"><?php echo e(number_format($modal2023 + $saldo2023, 0, ',', '.')); ?></td>
            </tr>
        </tbody>
    </table>
</body>
</html>
<?php /**PATH C:\dedeProject\Development\hisabuna\resources\views\report\perubahanekuitas.blade.php ENDPATH**/ ?>