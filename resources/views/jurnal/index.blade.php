        ...
        <div class="panel-body">
            ...
            <div class="overflow-hidden rounded-2xl border border-secondary-200/50 shadow-soft">
                ...
                <div x-show="!isLoading && !hasError" class="lg:hidden space-y-4 p-4">
                    ...
                    {{-- <template x-show="isSearching" x-for="i in 6" :key="'search-mobile-' + i">
                        <div class="bg-white rounded-lg border border-gray-200 p-4 shadow-sm">
                            <div class="flex items-start justify-between mb-3">
                                <div class="flex-1">
                                    <div class="h-3 animate-pulse bg-gray-200 rounded w-20 mb-2" :style="`animation-delay: ${i * 100}ms`"></div>
                                    <div class="h-5 skeleton-shimmer rounded" :class="i % 2 === 0 ? 'w-24' : 'w-32'" :style="`animation-delay: ${i * 150}ms`"></div>
                                </div>
                                <div class="h-5 skeleton-shimmer rounded-full" :class="i % 3 === 0 ? 'w-12' : i % 3 === 1 ? 'w-14' : 'w-16'" :style="`animation-delay: ${i * 120}ms`"></div>
                            </div>
                            <div class="mb-4">
                                <div class="h-3 animate-pulse bg-gray-200 rounded w-16 mb-2" :style="`animation-delay: ${i * 180}ms`"></div>
                                <div class="h-4 skeleton-shimmer rounded w-full mb-2" :style="`animation-delay: ${i * 200}ms`"></div>
                                <div class="h-4 animate-pulse bg-gray-200 rounded" :class="i % 2 === 0 ? 'w-3/4' : 'w-2/3'" :style="`animation-delay: ${i * 220}ms`"></div>
                            </div>
                            <div class="flex items-center justify-end gap-2 pt-3 border-t border-gray-100">
                                <div class="h-8 w-8 animate-pulse bg-gray-200 rounded-lg" :style="`animation-delay: ${i * 100}ms`"></div>
                                <div class="h-8 w-8 animate-pulse bg-gray-200 rounded-lg" :style="`animation-delay: ${i * 130}ms`"></div>
                                <div class="h-8 w-8 animate-pulse bg-gray-200 rounded-lg" :style="`animation-delay: ${i * 160}ms`"></div>
                            </div>
                        </div>
                    </template> --}}
                ...
                <div x-show="!isLoading && !hasError" class="hidden lg:block overflow-x-auto">
                    ...
                    <table x-show="!isSearching && paginatedData.length > 0" class="w-full min-w-full bg-white" id="jurnalTable">
                        ...
                        <tbody id="jurnalTableBody" class="divide-y divide-gray-200">
                            ...
                            {{-- <template x-show="isSearching" x-for="i in 8" :key="'search-desktop-' + i">
                                <tr class="t-row">
                                    <td class="t-cell">
                                        <div class="h-4 skeleton-shimmer rounded" :class="i % 3 === 0 ? 'w-20' : i % 3 === 1 ? 'w-24' : 'w-28'" :style="`animation-delay: ${i * 80}ms`"></div>
                                    </td>
                                    <td class="t-cell text-center">
                                        <div class="h-5 skeleton-shimmer rounded-full mx-auto" :class="i % 4 === 0 ? 'w-12' : i % 4 === 1 ? 'w-14' : i % 4 === 2 ? 'w-16' : 'w-18'" :style="`animation-delay: ${i * 120}ms`"></div>
                                    </td>
                                    <td class="t-cell">
                                        <div class="space-y-2">
                                            <div class="h-4 skeleton-shimmer rounded max-w-xs" :class="i % 2 === 0 ? 'w-full' : 'w-5/6'" :style="`animation-delay: ${i * 100}ms`"></div>
                                            <div class="h-3 animate-pulse bg-gray-200 rounded" :class="i % 3 === 0 ? 'w-2/3' : i % 3 === 1 ? 'w-1/2' : 'w-3/4'" :style="`animation-delay: ${i * 140}ms`"></div>
                                        </div>
                                    </td>
                                    <td class="t-cell">
                                        <div class="flex items-center justify-center gap-2">
                                            <div class="h-8 w-8 animate-pulse bg-gray-200 rounded-lg" :style="`animation-delay: ${i * 90}ms`"></div>
                                            <div class="h-8 w-8 animate-pulse bg-gray-200 rounded-lg" :style="`animation-delay: ${i * 110}ms`"></div>
                                            <div class="h-8 w-8 animate-pulse bg-gray-200 rounded-lg" :style="`animation-delay: ${i * 130}ms`"></div>
                                        </div>
                                    </td>
