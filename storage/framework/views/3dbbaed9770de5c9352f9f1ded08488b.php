...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'w-full md:w-auto lg:w-auto md:mt-0 mt-1','xOn:click.prevent' => '$dispatch(\'open-modal\', { route: `'.e(route('coas.show', '')).'/${coa.id}`, name: \'coas.show\', title: \'Lihat Akun\', data: coa, type: \'form\' })']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-full md:w-auto lg:w-auto md:mt-0 mt-1','x-on:click.prevent' => '$dispatch(\'open-modal\', { route: `'.e(route('coas.show', '')).'/${coa.id}`, name: \'coas.show\', title: \'Lihat Akun\', data: coa, type: \'form\' })']); ?><?php echo e(__('View')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\dedeProject\Development\hisabuna\resources\views/coas/index.blade.php ENDPATH**/ ?>