            ...
            <div class="bg-secondary-50 p-4 rounded-lg border border-secondary-200 mb-6">
                ...
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center gap-2">
                        <a href="{{ route('report.preview-coa') }}" target="_blank" class="h-10 px-3 bg-white border border-info-300 text-info-700 hover:bg-info-50 rounded-lg text-sm font-medium transition-all duration-200 flex items-center gap-2 whitespace-nowrap">
                        ...
                        <form method="POST" action="{{ route('coas.export') }}" class="inline-block">
                            @csrf
