                ...
                <div class="flex flex-wrap items-center justify-between">
                    <div id="filterAkun" class="flex-grow rounded p-3 flex flex-wrap gap-2 w-full md:w-auto justify-between">
                        <div class="flex flex-wrap gap-2 h-fit">
                            ...
                            <!-- <a href="<?php echo e(route('report.daftarjurnal')); ?>" class="btn btn-filter">
                        ...
                        <?php if(auth()->user()->profile == 'trial' && auth()->user()->is_active == 1): ?>
                            <a role="button"
                                ...
                                href="<?php echo e(route('jurnal.create')); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    ...
                                    <td class="text-left  px-3 py-2">
                                        <div class="flex items-center flex-col md:flex-row gap-2">
                                            <a class="btn btn-action-primary"
                                                :href="`<?php echo e(url('jurnal')); ?>/${jurnal.id}/edit`">
                                                Edit
                                            </a>

                                            <a class="btn cursor-pointer btn-action-secondary" x-data="{ data: jurnal }"
                                                x-on:click.prevent="$dispatch('open-modal', { route: `<?php echo e(route('jurnal.show', '')); ?>/${jurnal.id}`, name: 'jurnal.show', title: 'Lihat Jurnal', data: jurnal, type: 'form' })"><?php echo e(__('View')); ?></a>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#print').click(function(e) {
                    ...
                    if (a && b) {
                        $.ajax({
                            url: '<?php echo e(route("printReport")); ?>', // Sesuaikan dengan route yang benar
                            type: 'POST',
                            data: {
                                a: a,
                                b: b,
...
<?php endif; ?>
<?php /**PATH /var/www/trial_hisabuna/backend/resources/views/jurnal/index.blade.php ENDPATH**/ ?>