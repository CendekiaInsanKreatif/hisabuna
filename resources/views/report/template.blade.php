        ...
        <div class="container-card-report mt-1 flex flex-row gap-5 w-full p-2">
            <div class="report-card p-2 bg-slate-50 border hover:bg-slate-100 border-slate-200 rounded-md flex justify-between items-center w-full cursor-pointer">
                ...
                <div class="flex gap-3 items-center">
                    ...
                    @endif
                    @if (in_array($i['route'], ['/report/neraca-perbandingan', '/report/neraca', '/report/labarugi', '/report/aruskas', '/report/perubahanekuitas']))
                    ...
                    @endif
                    <button @click="downloadReport('{{ $i['route'] }}', {{ $loop->index }})" class="h-fit text-sm border border-slate-500 py-1 px-2 rounded-md hover:bg-slate-200">Preview</button>
        ...
        @endphp
            <div id="showReport{{ $loop->index }}" class="hidden container-card-report w-full p-2">
                <div class="flex justify-evenly p-2">
                    <div class="px-1">
                        <label for="alamat_{{$loop->index}}" class="block text-sm font-medium text-gray-700">Alamat</label>
                    ...
                    <div class="px-1">
                        <label for="dibuat_{{$loop->index}}" class="block text-sm font-medium text-gray-700">Dibuat</label>
