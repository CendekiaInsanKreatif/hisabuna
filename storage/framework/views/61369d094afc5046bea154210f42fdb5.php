                ...
                <div class="container mx-auto p-4">
                    <div class="flex flex-wrap gap-4 md:gap-6 items-center">
                        ...
                        <div class="flex items-center mt-4 md:mt-0">
                            <button class="inline-flex items-center justify-center px-2 py-1 bg-emerald-500 dark:bg-emerald-200 border border-transparent rounded-md font-semibold text-xs text-white dark:text-emerald-800 uppercase tracking-widest hover:bg-emerald-700 dark:hover:bg-white focus:bg-emerald-700 dark:focus:bg-white active:bg-emerald-900 dark:active:bg-emerald-300 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 dark:focus:ring-offset-emerald-800 transition ease-in-out duration-150 shadow-custom-strong py-2 px-4" x-on:click.prevent="$dispatch('open-modal', { route: '<?php echo e(route('coas.store')); ?>', name: 'coas.create', title: 'Tambah Akun', type: 'form' })">
                                Tambah Akun
                            </button>
                        </div>
                    ...
                    <table class="w-full min-w-full" id="coaTable">
                        ...
                        <tbody id="coaTableBody">
                            <template x-for="coa in paginatedData" :key="coa.id">
                                <tr @mouseover="hover = true" @mouseout="hover = false" class="cursor-pointer hover:bg-gray-100" x-on:click.prevent="$dispatch('open-modal', { route: `<?php echo e(route('coas.show', '')); ?>/${coa.id}`, name: 'coas.show', title: 'Lihat Akun', data: coa, type: 'form' })">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\hisabuna\resources\views/coas/index.blade.php ENDPATH**/ ?>